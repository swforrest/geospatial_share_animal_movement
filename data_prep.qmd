---
title: "Kākā SSF data preparation"
...
Here we are preparing GPS data of kākā at Orokonui Ecosanctuary for use in individual-level and population-level step selection functions. We will be using the `amt` package to prepare the data for fitting the step selection functions [@Signer2019-fi].
